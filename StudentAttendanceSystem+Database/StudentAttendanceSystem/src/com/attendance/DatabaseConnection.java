...
public class DatabaseConnection {
	static Connection con;
		...
		//	return DriverManager.getConnection("jdbc:mysql://localhost:3306/student_attendance?useSSL=false&allowPublicKeyRetrieval=true");
			return DriverManager.getConnection("jdbc:mysql://localhost:3306/student_attendance","root","system");
