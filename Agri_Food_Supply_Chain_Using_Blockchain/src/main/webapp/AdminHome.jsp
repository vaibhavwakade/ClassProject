		 ...
		 <div class="row">
		  <div class="col-sm-12 col-md-8">
			...
			<table align="center">
				...
				<tr>
					<td><span style="font-size:22px; color: red">Welcome to Farmer Section</span></td>
				</tr>
				<tr>
					<td align="center">Home Page <span style="font-size:22px; color: red">(by Best developer)</span></td>
				</tr>
            </table>			
				</div>
				</div>
